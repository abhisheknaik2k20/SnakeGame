...
class Snake:
    def __init__(self,game_window):
        self.size=20
        self.position= Position(game_window.width //2 , game_window.height//2, self.size)
        self.speed=0.2
        self.direction=(1,0)
        self.length=1
    ...
    def draw(self, screen) : pygame.draw.rect(screen, (200, 50, 50), (self.position.x, self.position.y, self.size, self.size))
